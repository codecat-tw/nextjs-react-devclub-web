    ...
    return (
        <>
            <div className="h-[300vh] relative bg-black scroll-smooth">
                {/*左側導航*/}
                <div
                    className={`sticky z-50 top-16 left-0 w-48 px-4 flex flex-col gap-4 text-white`}
                    style={{
                ...
                <div className={"sticky top-0 left-0 -mt-48 h-screen w-screen"}>
                    ...
                    <div style={{
                        ...
                        >
                            {/*按鈕*/}
                            <button
                                className="w-full h-full bg-transparent border border-gray-700 rounded-md group-hover:border-gray-500 transition-all duration-300">
                                <span className="text-white text-xl">測試鈕</span>
                            </button>

                            {/*懸浮內容*/}
                            <div
                                className={`fixed inset-0 flex items-center justify-center bg-black/80 backdrop-blur-smtransition-all duration-300  ${isHovered ? 'opacity-100 visible' : 'opacity-0 invisible'}`}
                            >
